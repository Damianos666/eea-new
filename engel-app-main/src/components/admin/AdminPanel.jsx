...
// Długie przytrzymanie "Użytkownicy" (index 2) → Rozliczenia (desktop index 7)
const MOBILE_TABS = [
  ["Terminarz",    0],  // [label, desktopIndex]
  ["Wiadomości",   2],  // długie przytrzymanie → Edytor szkoleń (index 3)
  ["Użytkownicy",  4],  // długie przytrzymanie → Rozliczenia (index 7)
  ["Zgłoszenia",   5],  // długie przytrzymanie ↔ Rejestracje (index 6)
];
          ...
          return (
            ...
            >
              ...
              <span style={{ fontSize: 9, fontWeight: 700, color: isActiveRender ? C.black : C.greyMid, letterSpacing: .5, textTransform: "uppercase" }}>
                {isSchedule && isClientView ? "Widok klienta" : isMessages && isEditorView ? "Edytor" : (renderDesktopIdx === 4 && settlView === "settlements") ? "Rozliczenia" : renderLabel}
              </span>
            </button>
          );
        })}
