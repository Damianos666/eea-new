                ...
                <>
                  ...
                  <div style={lockedFieldsStyle}>
                    <div style={{ background:C.white, borderRadius:10, padding:14, marginBottom:12, border:`1px solid ${C.grey}` }}>
                      ...
                      <div style={{ marginBottom:10 }}><span style={lbl()}>{"Nazwa firmy *"}</span><input value={clientName} onChange={e=>setClientName(e.target.value)} placeholder="np. HORIZONT ROLOS Sp. z o.o." style={inp()} /></div>
